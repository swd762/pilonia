                ...
                <div class="about-us block">
                    ...
                    <div class="row">
                        <div class="subscribe col-lg-3">
                            ...
                            <!--                            <div class="socials">-->
                            <!--                                <a href="#"><img src="-->
							<?php //echo get_template_directory_uri() . '/images/icons/facebook.svg' ?><!--" alt=""></a>-->
                            <!--                                <a href="#"><img src="-->
							<?php //echo get_template_directory_uri() . '/images/icons/insta.svg' ?><!--" alt=""></a>-->
                            <!--                                <a href="#"><img src="-->
							<?php //echo get_template_directory_uri() . '/images/icons/twitter.svg' ?><!--" alt=""></a>-->
                            <!--                                <a href="#"><img src="-->
							<?php //echo get_template_directory_uri() . '/images/icons/youtube.svg' ?><!--" alt=""></a>-->
                            <!--                                <a href="#"><img src="-->
							<?php //echo get_template_directory_uri() . '/images/icons/linked.svg' ?><!--" alt=""></a>-->
                            <!--                            </div>-->
                        </div>
                        <div class="col-lg-9">
                            <div class="desc">
            ...
            <div class="video-about-wrapper">
                <div class="video-bg-container">
                    <video autoplay loop muted id="homes-header-video">
                        <source src="<?php echo get_template_directory_uri() . '/images/videos/main_pilonia.mp4' ?>" type="video/mp4">
                    </video>
                ...
                <div class="news block">
                    ...
                    <div class="news-item">
                        <div class="row">
                            ...
                            <div class="col-xl-9">
                                <div class="row">
                                    <div class="col-12 col-md-4 col-xl-4 header-text">
                                        <div class="header">
                                    ...
                                    <div class="col-12 col-md-8 col-xl-8 header-pic">
                                ...
                                <div class="row justify-content-end">
                                    <div class="col-xl-8">
                                        <div class="row news-gallery justify-content-end">
                                            ...
                                            <!--                                            <div class="col-12 col-sm-6 col-md-4 col-lg-4 col-xl-4 gallery-pics align-self-end">-->
                                            <!--                                                <img src="-->
											<?php //echo get_template_directory_uri() . '/images/news-1-2.jpg' ?><!--" alt="">-->
                                            <!--                                            </div>-->
                                            <div class="col-12 col-sm-6 col-md-4 col-lg-4 col-xl-4 gallery-pics align-self-end">
                                            ...
                                            <!--                                            <div class="col-12 col-sm-6 col-md-4 col-lg-4 col-xl-4 gallery-pics align-self-end">-->
                                            <!--                                                <img src="-->
											<?php //echo get_template_directory_uri() . '/images/news-1-4.jpg' ?><!--" alt="">-->
                                            <!--                                            </div>-->
                                            <div class="col-12 col-sm-6 col-md-4 col-lg-4 col-xl-4 gallery-pics align-self-end">
                                ...
                                <div class="row justify-content-end">
                                    <div class="col-xl-8">
                                        <div class="row news-gallery justify-content-end">
                                            ...
                                            <div class="col-12 col-sm-6 col-md-4 col-lg-4 col-xl-4 gallery-pics align-self-end">
                                                <img src="<?php echo get_template_directory_uri() . '/images/news-2-3.jpg' ?>" alt="">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="news-item">
                        <div class="row">
                            ...
                            <div class="col-xl-9">
                                <div class="row">
                                    <div class="col- col-md-4 col-xl-4 header-text">
                                        <div class="header">
                                ...
                                <div class="row justify-content-end">
                                    <div class="col-xl-8">
                                        <div class="row news-gallery justify-content-end">
                                            ...
                                            <!--                                            <div class="col-12 col-sm-6 col-md-4 col-lg-4 col-xl-4 gallery-pics align-self-end">-->
                                            <!--                                                <img src="-->
											<?php //echo get_template_directory_uri() . '/images/news-3-3.jpg' ?><!--" alt="">-->
                                            <!--                                            </div>-->
                                            <div class="col-12 col-sm-6 col-md-4 col-lg-4 col-xl-4 gallery-pics align-self-end">
            ...
            <div class="container">
                <div class="contact-us block">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-8">
                            <div class="row">
                                <div class="col-xl-6 col-md-6 col-sm-5 col-12 instruction">
